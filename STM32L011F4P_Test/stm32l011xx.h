...
typedef struct
{
  ...
  volatile uint32_t CALFACT;    /*!< ADC data register,                                          Address offset:0xB4 */
} ADC_TypeDef;
...
typedef struct
{
  volatile uint32_t CSR; /* COMP comparator control and status register, Address offset: 0x18 */
} COMP_TypeDef;
...
typedef struct
{
	...
	uint8_t 					RES0;   /*!< Reserved,                                                     0x05 */
	uint16_t 					RES1;   /*!< Reserved,                                                     0x06 */
	volatile uint32_t CR;     /*!< CRC Control register,                         Address offset: 0x08 */
	uint32_t 					RES2;   /*!< Reserved,                                                     0x0C */
...
typedef struct
{
  volatile uint32_t ACR;           /*!< Access control register,                     Address offset: 0x00 */
  volatile uint32_t PECR;          /*!< Program/erase control register,              Address offset: 0x04 */
  volatile uint32_t PDKEYR;        /*!< Power down key register,                     Address offset: 0x08 */
  volatile uint32_t PEKEYR;        /*!< Program/erase key register,                  Address offset: 0x0c */
  volatile uint32_t PRGKEYR;       /*!< Program memory key register,                 Address offset: 0x10 */
  volatile uint32_t OPTKEYR;       /*!< Option byte key register,                    Address offset: 0x14 */
  volatile uint32_t SR;            /*!< Status register,                             Address offset: 0x18 */
  volatile uint32_t OPTR;          /*!< Option byte register,                        Address offset: 0x1c */
...
typedef struct
{
  volatile uint32_t RDP;               /*!< Read protection register,               Address offset: 0x00 */
  volatile uint32_t USER;              /*!< user register,                          Address offset: 0x04 */
  volatile uint32_t WRP01;             /*!< write protection Bytes 0 and 1          Address offset: 0x08 */
} OB_TypeDef;
...
typedef struct
{
  ...
  volatile uint32_t CFGR2;         /*!< SYSCFG configuration register 2,                    Address offset: 0x04 */
  volatile uint32_t EXTICR[4];     /*!< SYSCFG external interrupt configuration register,   Address offset: 0x14-0x08 */
					 uint32_t RESERVED[2];   /*!< Reserved,                                           0x18-0x1C */
  volatile uint32_t CFGR3;         /*!< SYSCFG configuration register 3,                    Address offset: 0x20 */       
} SYSCFG_TypeDef;
...
typedef struct
{
  ...
  volatile uint32_t CIER;          /*!< RCC Clock interrupt enable register,                          Address offset: 0x10 */
  volatile uint32_t CIFR;          /*!< RCC Clock interrupt flag register,                            Address offset: 0x14 */
  volatile uint32_t CICR;          /*!< RCC Clock interrupt clear register,                           Address offset: 0x18 */
  volatile uint32_t IOPRSTR;       /*!< RCC IO port reset register,                                   Address offset: 0x1C */
  volatile uint32_t AHBRSTR;       /*!< RCC AHB peripheral reset register,                            Address offset: 0x20 */
  volatile uint32_t APB2RSTR;      /*!< RCC APB2 peripheral reset register,                           Address offset: 0x24 */
  volatile uint32_t APB1RSTR;      /*!< RCC APB1 peripheral reset register,                           Address offset: 0x28 */
  volatile uint32_t IOPENR;        /*!< RCC Clock IO port enable register,                            Address offset: 0x2C */
  volatile uint32_t AHBENR;        /*!< RCC AHB peripheral clock enable register,                     Address offset: 0x30 */
  volatile uint32_t APB2ENR;       /*!< RCC APB2 peripheral enable register,                          Address offset: 0x34 */
  volatile uint32_t APB1ENR;       /*!< RCC APB1 peripheral enable register,                          Address offset: 0x38 */
  volatile uint32_t IOPSMENR;      /*!< RCC IO port clock enable in sleep mode register,              Address offset: 0x3C */
  volatile uint32_t AHBSMENR;      /*!< RCC AHB peripheral clock enable in sleep mode register,       Address offset: 0x40 */
  volatile uint32_t APB2SMENR;     /*!< RCC APB2 peripheral clock enable in sleep mode register,      Address offset: 0x44 */
  volatile uint32_t APB1SMENR;     /*!< RCC APB1 peripheral clock enable in sleep mode register,      Address offset: 0x48 */
  volatile uint32_t CCIPR;         /*!< RCC clock configuration register,                             Address offset: 0x4C */
  volatile uint32_t CSR;           /*!< RCC Control/status register,                                  Address offset: 0x50 */
} RCC_TypeDef;
...
#define DMA1_Channel6_BASE    (DMA1_BASE + 0x0000006CU) // STM32L031
#define DMA1_Channel7_BASE    (DMA1_BASE + 0x00000080U) // STM32L031
...
#define GPIOH_BASE            (IOPPERIPH_BASE + 0x00001C00U) // STM32L031

#define VREF_CAL			   (*((unsigned short*)0x1FF80078))
...
#define DMA1_Channel6       ((DMA_Channel_TypeDef *) DMA1_Channel6_BASE) // STM32L031
#define DMA1_Channel7       ((DMA_Channel_TypeDef *) DMA1_Channel7_BASE) // STM32L031
...
#define GPIOH               ((GPIO_TypeDef *) GPIOH_BASE) // STM32L031
...
static inline void NVIC_SetPriority(unsigned int IRQn, uint32_t priority)
{
	if ( priority > 3 ) priority = 3;
	unsigned char i = IRQn >> 2;
	unsigned char s = (IRQn & 3) << 3; 
  NVIC->IP[i] = (NVIC->IP[i] & ~(0xFFU << s)) | ((priority << 6) << s);
}

static inline void NVIC_Enable_All() { __asm volatile("CPSIE i"); }
static inline void NVIC_Disable_All() { __asm volatile("CPSID i"); }
...
#define SCB_SCR_SEVONPEND              (1UL << SCB_SCR_SEVONPEND_Pos)                 /*!< SCB SCR: SEVONPEND Mask */

#define SCB_SCR_SLEEPDEEP_Pos          2U                                            /*!< SCB SCR: SLEEPDEEP Position */
#define SCB_SCR_SLEEPDEEP              (1UL << SCB_SCR_SLEEPDEEP_Pos)                 /*!< SCB SCR: SLEEPDEEP Mask */

#define SCB_SCR_SLEEPONEXIT_Pos        1U                                            /*!< SCB SCR: SLEEPONEXIT Position */
#define SCB_SCR_SLEEPONEXIT            (1UL << SCB_SCR_SLEEPONEXIT_Pos)               /*!< SCB SCR: SLEEPONEXIT Mask */
...
#define GPIO_0_Pos            (0U)                                   
#define GPIO_1_Pos            (2U)                                   
#define GPIO_2_Pos            (4U)                                   
#define GPIO_3_Pos            (6U)                                   
#define GPIO_4_Pos            (8U)                                   
#define GPIO_5_Pos            (10U)                                  
#define GPIO_6_Pos            (12U)                                  
#define GPIO_7_Pos            (14U)                                  
#define GPIO_8_Pos            (16U)                                  
#define GPIO_9_Pos            (18U)                                  
#define GPIO_10_Pos           (20U)                                  
#define GPIO_11_Pos           (22U)                                  
#define GPIO_12_Pos           (24U)                                  
#define GPIO_13_Pos           (26U)  
#define GPIO_14_Pos           (28U)
#define GPIO_15_Pos           (30U)

#define GPIO_MODE_INPUT(ptr,index) \
	(ptr)->MODER &= ~(3U << ((index)<<1))
#define GPIO_MODE_OUTPUT(ptr,index) \
	(ptr)->MODER = ((ptr)->MODER & ~(2U << ((index)<<1))) | (1U << ((index)<<1))
#define GPIO_MODE_ALT(ptr,index) \
	(ptr)->MODER = ((ptr)->MODER & ~(1U << ((index)<<1))) | (2U << ((index)<<1))
#define GPIO_MODE_ANALOG(ptr,index) \
	(ptr)->MODER |= (3U << ((index)<<1))
	

/******************  Bit definition for GPIO_OTYPER register  *****************/

#define GPIO_OPEN_DRAIN_ON(ptr,index) (ptr)->OTYPER |= (1U << (index))
#define GPIO_OPEN_DRAIN_OFF(ptr,index) (ptr)->OTYPER &= ~(1U << (index))

/****************  Bit definition for GPIO_OSPEEDR register  ******************/

#define GPIO_SPEED_SLOW(ptr,index) \
	(ptr)->OSPEEDR &= ~(3U << ((index)<<1))
#define GPIO_SPEED_MEDIUM(ptr,index) \
	(ptr)->OSPEEDR = ((ptr)->OSPEEDR & ~(2U << ((index)<<1))) | (1U << ((index)<<1))
#define GPIO_SPEED_FAST(ptr,index) \
	(ptr)->OSPEEDR = ((ptr)->OSPEEDR & ~(1U << ((index)<<1))) | (2U << ((index)<<1))
#define GPIO_SPEED_VERY_FAST(ptr,index) \
	(ptr)->OSPEEDR |= (3U << ((index)<<1))

/*******************  Bit definition for GPIO_PUPDR register ******************/

#define GPIO_PULL_NONE(ptr,index) \
	(ptr)->PUPDR &= ~(3U << ((index)<<1))
#define GPIO_PULL_UP(ptr,index) \
	(ptr)->PUPDR = ((ptr)->PUPDR & ~(2U << ((index)<<1))) | (1U << ((index)<<1))
#define GPIO_PULL_DOWN(ptr,index) \
	(ptr)->PUPDR = ((ptr)->PUPDR & ~(1U << ((index)<<1))) | (2U << ((index)<<1))

/*******************  Bit definition for GPIO_IDR register  *******************/

#define GPIO_READ(ptr,index) (((ptr)->IDR >> index) & 1U)

/******************  Bit definition for GPIO_ODR register  ********************/

#define GPIO_READ_OUTPUT(ptr,index) (((ptr)->ODR >> index) & 1U)

/****************** Bit definition for GPIO_BSRR register  ********************/

#define GPIO_SET(ptr,index) (ptr)->BSRR = (1U << index)
#define GPIO_CLEAR(ptr,index) (ptr)->BRR = (1U << index)

/****************** Bit definition for GPIO_AFR registers ********************/

#define GPIO_ALT_FUNC(ptr,index,value) \
	(ptr)->AFR[(index)>>3] = ((ptr)->AFR[(index)>>3] & ~(15U << (((index)&7)<<2))) | (value << (((index)&7)<<2))
...
#define RCC_IOPRSTR_GPIOHRST                RCC_IOPRSTR_IOPHRST        /*!< GPIO port H reset, STM32L031 */
...
#define RCC_IOPENR_GPIOHEN                  RCC_IOPENR_IOPHEN        /*!< GPIO port H clock enable, STM32L031 */
